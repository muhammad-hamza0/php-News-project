        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                     <?php
                        $title_query = "SELECT * FROM user WHERE user_id = $id";
                        $title_result = mysqli_query($con, $title_query) or die('Query Faild: Title');
                        $auth_data = mysqli_fetch_assoc($title_result);
                        ...
                        $pagination_query = "SELECT * FROM post JOIN user ON post.author = user.user_id
                                            WHERE user_id = $id";
